using IECODE.Core.Formats.Criware.CriFs.Structs;
...
using static IECODE.Core.Formats.Criware.CriFs.Utilities.Parsing.CpkHelper;

namespace IECODE.Core.Formats.Criware.CriFs.Encryption.Game;
